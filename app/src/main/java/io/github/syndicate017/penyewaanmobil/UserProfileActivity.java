...
public class UserProfileActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Show pop up message
        Toast toast = Toast.makeText(getApplicationContext(), "Your data was successfully created", Toast.LENGTH_SHORT);
        toast.show();
    ...
    public void onBackPressed() {
        ...
        Toast.makeText(this, "Please click BACK again to go to Login Screen", Toast.LENGTH_SHORT).show();
